...
(function (global, factory) {
  ...
  function IroHandle(props) {
      ...
      return (h("svg", { className: "IroHandle", x: props.x, y: props.y, style: { overflow: 'visible' } },
          ...
          !url && (h("circle", { r: radius - 2, fill: "none", "stroke-width": 2, stroke: "#fff" }))));
  }
  ...
  function IroWheel(props) {
      ...
      return (h(IroComponentBase, { onInput: handleInput }, function (uid, rootProps, rootStyles) { return (h("svg", Object.assign({}, rootProps, { className: "IroWheel", width: width, height: width, style: rootStyles }),
          h("defs", null,
  ...
  function IroSlider(props) {
      ...
      return (h(IroComponentBase, { onInput: handleInput }, function (uid, rootProps, rootStyles) { return (h("svg", Object.assign({}, rootProps, { className: "IroSlider", width: width, height: height, style: Object.assign({}, rootStyles,
              m$1(props)) }),
          h("defs", null,
  ...
  var IroColorPicker = /*@__PURE__*/(function (Component) {
      ...
      IroColorPicker.prototype.render = function render (props, state) {
          ...
          return (h("div", { class: "IroColorPicker", id: state.id, style: ( obj = {
                  display: state.display
              }, obj[props.layoutDirection === 'vertical' ? 'width' : 'height'] = state.width, obj ) }, state.layout.map(function (ref) {
  ...
  function IroBox(props) {
      ...
      return (h(IroComponentBase, { onInput: handleInput }, function (uid, rootProps, rootStyles) { return (h("svg", Object.assign({}, rootProps, { className: "IroBox", width: width, height: height, style: Object.assign({}, rootStyles,
              E(props)) }),
          h("defs", null,
